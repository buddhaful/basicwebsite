...
<head>
    ...
    <title>Vietnamese Resettlement - Overview</title>
   <!-- This original content created by Virginia Lopez-Nadal October 8, 2017 -->
...
<body>
    <div id="container">
        <div id="header">
            <img src="images/banner.jpg" alt="Vietnamese refugees are taken on to ship by Americans.">
            <h1>Vietnamese Resettlement in the United States</h1>
            <div id="navbar">
                <ul id="menu">
        ...
        <div id="content">
            ...
            <!-- Beginning of information about topic -->
            ...
            <p><img src="images/vietnam_protest.jpg" width="269" height="400" alt="Vietnam War protest in Washington, D.C., 1967."></p>
                <p><em>Vietnam War protest in Washington, D.C., 1967.</em></p>
            ...
            <p><img src="images/vietnamese_refugees.jpg" width="494" height="400" alt="Vietnamese refugees being transported during Operation Frequent Wind."></p>
                <p><em>Vietnamese refugees being transported during Operation Frequent Wind.</em></p>
        </div> <!-- end content -->
        <div id="sidebar">
            <h2>Did You Know?</h2>
            Many considered the Vietnamese an inherently weak and feminine race. These stereotypes only became reinforced for others considering the Vietnamese often pursued entrepreneurship working in businesses such as nail shops. Unlike some other immigrate groups, the Vietnamese would take on these jobs even if labelled "feminine". This is because they are culturally very family-oriented rather than individualistic like Americans are.
        </div> <!-- end sidebar -->
        <div id="footer">
            <p><em><a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" /></a> <a href="mailto:vlopeznadal@icloud.com">Virginia Lopez-Nadal</a></em></p>
        </div> <!-- end footer -->
    </div> <!-- end container -->
</body>
</html>
